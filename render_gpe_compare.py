...
# whatever currently sits in set1_rheology — refreshed when the friction DD-VMs are promoted.)
...
OUT_SUITE1 = "out/paper/figures/gpe_compare_suite1.png"     # Figure 5: Suite-1 robustness (2×2) — the ONLY output
WINDOW_KM = 200
