...
REGISTRY = [
    ...
    ("ConvLoadIncPct", lambda: 100 * abs(row("convergence", model="bench_800x48_ns12")["dGPE_TN"] / row("convergence", configuration="24 (baseline)")["dGPE_TN"] - 1), ".2f",
     "Table S3: pull change 12 vs 24 load increments [%]", [("si.tex", 214, "0.04")]),
