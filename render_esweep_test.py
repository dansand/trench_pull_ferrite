...
V-sweep and N_D-sweep already trace, NOT off it.  Writes out/paper/figures/esweep.png (Appendix B).
...
ESWEEP = [(0.125, f"{ES}/elastic_deep_60km_V4_E0p125"), (0.25, f"{ES}/elastic_deep_60km_V4_E0p25"),
          (0.5, f"{ES}/elastic_deep_60km_V4_E0p5"), (1.0, "out/paper/set1_rheology/elastic_deep_60km_V4"),
          (2.0, f"{ES}/elastic_deep_60km_V4_E2"), (4.0, f"{ES}/elastic_deep_60km_V4_E4"),
          (8.0, f"{ES}/elastic_deep_60km_V4_E8")]
OUT = "out/paper/figures/esweep.png"
E0_GPA = 70.0
