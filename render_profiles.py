...
MODELS = [("out/paper/set1_rheology/elastic_deep_60km_V4",    "elastic"),
          ("out/paper/set1_rheology/tresca_deep_150_60km_V4",  "elasto-plastic\n(Tresca)"),
          ("out/paper/set1_rheology/dd_vm_asym_60km_V4",    "DD-VM asym\n(weak top)"),
          ("out/paper/set1_rheology/dd_vm_sym_60km_V4",    "DD-VM sym\n(weak surf.)")]
OUT = "out/paper/figures/profiles.png"
