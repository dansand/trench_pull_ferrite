...
from render_core_thinning import core_thickness

MODEL = "out/paper/set1_rheology/tresca_deep_150_60km_V4"   # symmetric-Tresca baseline (M_p=1.35, V=4)
...
OUT = "out/paper/figures/core_profiles_deep60.png"
...
def main():
    ...
    diff = m.array("sigma_xx [Pa]") - m.array("sigma_zz [Pa]")
