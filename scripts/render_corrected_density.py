...
def main():
    ...
    ax[0].set_xlabel(r"corrected density  $\rho^{*}$  [kg m$^{-3}$]  (symlog about 3300)")
    ax[0].set_ylabel("depth  [km]")
    ax[0].set_title(r"(a)  corrected density  $\rho^{*}=\rho+g^{-1}\tau_{zx,x}$", fontsize=10.5)
    ...
    ax[1].set_xlabel(r"cumulative average  $\bar\rho^{*}(z)=z^{-1}\!\int_0^z\!\rho^{*}\,dz'$  [kg m$^{-3}$]")
