...
P = "out/paper"
# (V, N_D, path)
# Baseline is now V=4 (σ_Y=150, M_p=1.35).  V-sweep spans V1..V4.5 in set3; the V4 point IS the baseline.
SUITE2 = [(1.0, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V1"), (1.5, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V1p5"),
          (2.0, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V2"), (2.5, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V2p5"),
          (3.0, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V3"), (3.5, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V3p5"),
          (4.0, 0, f"{P}/set1_rheology/tresca_deep_150_60km_V4"), (4.5, 0, f"{P}/set3_v_sweep/tresca_deep_150_60km_V4p5")]
SUITE3 = [(4.0, -3, f"{P}/set2_nd_sweep/tresca_deep_150_60km_V4_mem-3"), (4.0, -2, f"{P}/set2_nd_sweep/tresca_deep_150_60km_V4_mem-2"),
          (4.0, -1, f"{P}/set2_nd_sweep/tresca_deep_150_60km_V4_mem-1"), (4.0, 1, f"{P}/set2_nd_sweep/tresca_deep_150_60km_V4_mem1"),
          (4.0, 2, f"{P}/set2_nd_sweep/tresca_deep_150_60km_V4_mem2"), (4.0, 3, f"{P}/set2_nd_sweep/tresca_deep_150_60km_V4_mem3")]
...
SUITE1 = [("elastic", f"{P}/set1_rheology/elastic_deep_60km_V4"), ("DD-VM asym", f"{P}/set1_rheology/dd_vm_asym_60km_V4"),
          ("DD-VM sym", f"{P}/set1_rheology/dd_vm_sym_60km_V4")]
OUT = f"{P}/figures/gpe_correlation.png"
