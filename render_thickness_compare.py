...
baseline, {30,40,50} are the set4_thickness sweep (V bisected per h; see paper_models.jl `thickness`).
...
MODELS = [("out/paper/set4_thickness/tresca_150_30km",             30,   "#c0392b"),
          ("out/paper/set4_thickness/tresca_150_40km",             40,   "#e67e22"),
          ("out/paper/set4_thickness/tresca_150_50km",             50,   "#2779b5"),
          ("out/paper/set1_rheology/tresca_deep_150_60km_V4",      60,   "#1f3b73")]
VLOAD = {30: 2.045, 40: 2.702, 50: 3.354, 60: 4.000}   # tuned load per plate [TN/m] (tuned_V.txt; 60 = baseline)
OUT = "out/paper/figures/thickness_compare.png"
WINDOW_KM = 220
GRAV = 9.81
