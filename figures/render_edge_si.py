...
rho = (m.array("dsxz_dx [Pa/m]") if m.has_field("dsxz_dx [Pa/m]") else m.grad_x_field(m.cauchy_fields()[2])) / G
...
fig.savefig("data/reference_figures/edge_effect_SI.png", dpi=200)
print("wrote data/reference_figures/edge_effect_SI.png")
print("\nSuggested caption:")
